  ...
  useEffect(() => {
    ...
    fetch(`/api/plays/${code}`)
      ...
      .then((json) => {
        ...
        // Set language to match the shared play's language
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            />
                            <p
                              className={`${accent.text} text-[10px] font-bold uppercase tracking-[0.18em] truncate`}
                            >
                              {sp.character}
                            </p>
                          </div>
