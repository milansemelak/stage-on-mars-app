    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#EDEDED] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-white/[0.06]">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
          <img src="/logo.png" alt="Stage On Mars" className="h-10 sm:h-14 w-auto invert" />
          <a
            href="#contact"
            className="text-xs sm:text-sm font-bold uppercase tracking-[0.15em] text-[#0a0a0a] bg-mars hover:bg-mars-light px-7 sm:px-9 py-2.5 rounded-full transition-all"
          >
            Go to Mars
          </a>
        </div>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 pt-20 pb-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl flex flex-col items-center">
          ...
          <p className="text-mars/60 text-xs sm:text-sm font-bold uppercase tracking-[0.3em] mb-6" style={{ textShadow: '0 1px 20px rgba(0,0,0,0.6)' }}>The Reality Play Platform</p>
          <h1 className="text-[56px] sm:text-[80px] md:text-[112px] lg:text-[128px] font-bold leading-[0.88] tracking-[-0.05em]" style={{ textShadow: '0 2px 40px rgba(0,0,0,0.5)' }}>
            Play to see
            <br />
          ...
          <p className="font-mercure text-[#EDEDED]/50 text-lg sm:text-[22px] sm:leading-[32px] max-w-lg mx-auto mt-8 sm:mt-10" style={{ textShadow: '0 1px 20px rgba(0,0,0,0.6)' }}>
      ...
      <section id="experience" className="relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center px-6 text-center pt-28 sm:pt-40 pb-16 sm:pb-24">
          <p className="text-mars text-xs font-bold uppercase tracking-[0.3em] mb-4">01 — Live Reality Play</p>
          <h2 className="text-[48px] sm:text-[72px] md:text-[96px] font-bold leading-[0.88] tracking-[-0.04em] mb-4">
            Play it. See it.
          </h2>
          <p className="font-mercure text-[#EDEDED]/50 text-lg sm:text-[22px] mb-16 sm:mb-20">
            Your question becomes a reality play on stage. What&apos;s invisible becomes obvious.
          </p>

          {/* 3 steps — inside the photo */}
          <div className="grid sm:grid-cols-3 gap-8 sm:gap-12 text-center max-w-4xl mx-auto">
            <div className="space-y-3">
              <p className="text-mars/40 text-[40px] sm:text-[56px] font-bold leading-none">1</p>
              <h3 className="text-[18px] sm:text-[22px] font-bold tracking-[-0.02em]">Bring a real question</h3>
              <p className="font-mercure text-[#EDEDED]/40 text-[14px] leading-[20px]">Something no meeting resolves. Something that shapes what happens next.</p>
            </div>
            <div className="space-y-3">
              <p className="text-mars/40 text-[40px] sm:text-[56px] font-bold leading-none">2</p>
              <h3 className="text-[18px] sm:text-[22px] font-bold tracking-[-0.02em]">Play it into reality</h3>
              <p className="font-mercure text-[#EDEDED]/40 text-[14px] leading-[20px]">Step into roles. Play the situation out on stage. What&apos;s hidden becomes visible.</p>
            </div>
            <div className="space-y-3">
              <p className="text-mars/40 text-[40px] sm:text-[56px] font-bold leading-none">3</p>
              <h3 className="text-[18px] sm:text-[22px] font-bold tracking-[-0.02em]">See beyond</h3>
              <p className="font-mercure text-[#EDEDED]/40 text-[14px] leading-[20px]">You see what&apos;s really driving it — beyond the current reality. And what needs to shift.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-[32px] sm:text-[48px] font-bold text-center mb-12 sm:mb-16 leading-[0.94] tracking-[-0.03em]">WHO&apos;S PLAYED THEIR REALITY?</h2>
      ...
      <section className="relative overflow-hidden py-24 sm:py-36 px-6">
        <img src="/fotka5.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
        <div className="absolute inset-0 bg-[#0a0a0a]/70" />
        <div className="relative z-10 max-w-4xl mx-auto">
          <p className="text-mars/50 text-xs font-bold uppercase tracking-[0.3em] mb-16 sm:mb-20 text-center">What they say about us</p>
          <div className="space-y-12 sm:space-y-16">
            {TESTIMONIALS.map((t, i) => (
              <div key={t.name} className={`${i % 2 === 0 ? 'sm:pr-24' : 'sm:pl-24'}`}>
                <p className="font-mercure italic text-white/85 text-[18px] sm:text-[22px] leading-[1.5] tracking-[-0.3px] mb-4">
                  &ldquo;{t.quote}&rdquo;
                </p>
      ...
      <section id="playmaker" className="relative overflow-hidden border-t border-white/[0.06]">
        ...
        <div className="pt-20 sm:pt-28 pb-10 sm:pb-14 px-6 text-center relative">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(255,85,0,0.06)_0%,_transparent_50%)]" />
          <div className="relative z-10 max-w-4xl mx-auto">
            <p className="text-mars text-xs font-bold uppercase tracking-[0.3em] mb-4">02 — Digital Reality Play</p>
            <h2 className="text-[48px] sm:text-[72px] md:text-[96px] font-bold leading-[0.88] tracking-[-0.04em] mb-6">
              The Playmaker.
            </h2>
            <p className="font-mercure text-[#EDEDED]/40 text-[16px] sm:text-[22px] max-w-2xl mx-auto whitespace-nowrap">
      ...
      <section id="space" className="relative overflow-hidden border-t border-white/[0.06]">
        ...
        <div className="relative h-[80vh] sm:h-[90vh]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
            <p className="text-mars text-xs font-bold uppercase tracking-[0.3em] mb-4">03 — The Stage</p>
            <h2 className="text-[48px] sm:text-[72px] md:text-[96px] font-bold leading-[0.88] tracking-[-0.04em] mb-8">
              The Flagship Studio.
            </h2>
            <p className="font-mercure text-[#EDEDED]/50 text-[16px] sm:text-[22px] max-w-md mb-8">
              A stage built for reality play.
            </p>
            <div className="mt-4">
              <p className="text-[24px] sm:text-[32px] font-bold tracking-[-0.02em]">Národní 138/10, Praha</p>
              <p className="font-mercure text-[#EDEDED]/35 text-[14px] sm:text-[16px] mt-2">One of a kind in the world.</p>
            </div>
            <div className="mt-10">
              <a
                href="/space"
      ...
      {/* The Team */}
      <section className="py-28 sm:py-40 px-6 border-t border-white/[0.06]">
        <div className="max-w-5xl mx-auto">
      ...
      <section id="contact" className="py-28 sm:py-40 px-6 relative overflow-hidden border-t border-white/[0.06]">
        ...
        <div className="relative z-10 max-w-xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-[40px] sm:text-[60px] font-bold leading-[0.94] tracking-[-0.03em]">What&apos;s your question?</h2>
            <p className="font-mercure text-[#EDEDED]/30 text-[16px] sm:text-[20px]">We reply within 24 hours.</p>
          </div>
