...
const UI = {
  en: {
    tagline1: "Play the future.",
    tagline2: "Then decide it.",
  ...
  cs: {
    tagline1: "Zahrajte si budoucnost.",
    tagline2: "Pak se rozhodněte.",
    ...
    headline: "Zahrajte si budoucnost.\nPak se rozhodněte.",
