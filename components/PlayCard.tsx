        ...
        <div className="p-5 sm:p-8 space-y-6 sm:space-y-8">
          ...
          {currentPlay.music?.track && currentPlay.music?.artist && (
            <a
              ...
              className="block animate-fade-slide-up stagger-5 rounded-2xl border border-mars/25 bg-mars/[0.06] hover:bg-mars/[0.10] hover:border-mars/40 p-4 sm:p-5 transition-all group"
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-mars/70 text-[10px] font-bold uppercase tracking-[0.18em]">{t.musicLabel}</span>
              </div>
              <div className="flex items-baseline justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="text-mars-light/80 text-sm truncate font-mercure italic">
                    {currentPlay.music.artist}
                  </p>
                </div>
                <span className="text-mars/40 group-hover:text-mars-light text-[10px] font-bold uppercase tracking-[0.15em] shrink-0 transition-colors">
                  {t.openOnSpotify} →
                </span>
              </div>
              {currentPlay.music.reason && (
                <p className="text-white/40 text-xs sm:text-sm mt-3 leading-relaxed font-mercure italic">
                  {currentPlay.music.reason}
                </p>
              )}
            </a>
