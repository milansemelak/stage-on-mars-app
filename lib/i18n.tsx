...
const translations = {
  en: {
    ...
    credibility: "Stage on Mars and the Method of Systemic Play have been used by leading companies, featured at Forbes conferences, and brought to prime-time reality TV across Europe. Step into it at our flagship space in Prague.",
    ...
    loading3: "The answer you want isn't the answer you need.",
    loading4: "Setting up the stage.",
    loading5: "Bodies are entering the space.",
    loading6: "Finding who's already standing in your question.",
  ...
  sk: {
    ...
    credibility: "Stage on Mars a Metódu Systemickej hry využívajú popredné firmy, prezentovali sme ju na konferenciách Forbes a priniesli do prime-time reality TV naprieč Európou. Zažite ju naživo v našom priestore v Prahe.",
    counterLive: "Otázok odohraných naživo",
    counterDigital: "Hier vygenerovaných tu",
    ...
    // Loading messages
    loading1: "Neexistuje zlá otázka.",
    loading2: "Každá otázka má svoju hru.",
    loading3: "Odpoveď, ktorú chceš, nie je odpoveď, ktorú potrebuješ.",
    loading4: "Staviam scénu.",
    loading5: "Telá vstupujú do priestoru.",
    loading6: "Hľadám, kto už stojí v tvojej otázke.",
    // Question suggestions — personal
  ...
  cs: {
    ...
    placeholder: "Jakou otázku chceš rozehrát?",
    ...
    credibility: "Stage on Mars a Metodu Systemické hry využívají přední firmy, prezentovali jsme ji na konferencích Forbes a přinesli do prime-time reality TV napříč Evropou. Zažijte ji naživo v našem prostoru v Praze.",
    counterLive: "Otázek odehraných naživo",
    counterDigital: "Her vygenerovaných zde",
    ...
    // Loading messages
    loading1: "Neexistuje špatná otázka.",
    loading2: "Každá otázka má svou hru.",
    loading3: "Odpověď, kterou chceš, není odpověď, kterou potřebuješ.",
    loading4: "Stavím scénu.",
    loading5: "Těla vstupují do prostoru.",
    loading6: "Hledám, kdo už stojí v tvé otázce.",
    // Question suggestions — personal
    trySuggestion: "Zkus",
