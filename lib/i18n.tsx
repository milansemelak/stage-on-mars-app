...
const translations = {
  en: {
    ...
    heroSubtitle: "Play what you're afraid to ask on Earth.",
    ...
    stepAsk: "Ask",
    stepAskDesc: "What is your biggest question?",
    stepPlay: "Play",
    stepPlayDesc: "The question becomes a play.",
    stepSee: "See",
    stepSeeDesc: "You'll see what you couldn't before.",
    // Loading messages
    ...
    bodyRitual: "Stand up. Place a hand on your chest. Then tap.",
    holdSilence: "Hold the silence.",
    sayItAloud: "Say it aloud.",
    replay: "Replay",
    author: "You",
    nextQuestion: "What's next?",
    askThis: "Play this →",
    whatsNext: "The next question",
    // Client name
    ...
    authSignedUpAs: "Signed up as",
    authLoggedInAs: "Logged in as",
    authSubscribe: "Subscribe",
    authUnlock: "Unlock",
    authSupernovaPlaceholder: "Enter Master Player Code",
    authSupernovaHave: "Have a Master Player Code?",
    authOr: "or",
    authCheckoutError: "Something went wrong. Try again.",
    authWrongCredentials: "Wrong email or password.",
    // Password reset
    authForgotPassword: "Forgot password?",
    authResetTitle: "Reset your password",
    authResetDesc: "We'll send you a link to reset it.",
    ...
    authNewPasswordMin: "New password (min 6 characters)",
    authResetSave: "Save new password",
    authResetSaving: "Saving...",
    authResetSuccess: "Password updated. Redirecting...",
    // History
    historyAll: "All",
    ...
    landingNamePlaceholder: "Your name",
    landingCTA: "Take it to Mars →",
    landingCTALoading: "Creating...",
    landingTrust: "1 free play · no signup · then 30 days free with an account",
    landingTrustExpired: "You've used your free play · create an account to continue",
    landingHaveAccount: "Already have an account?",
    landingSignIn: "Sign in",
    landingAskElse: "Ask something else",
    landingYourPlay: "Your play",
    landingCreatingPlay: "Creating your play...",
    landingChoreographing: "Choreographing the stage...",
    landingPerspectivesRevealed: "Perspectives revealed",
    landingJustRanTitle: "You just played with your reality",
    landingRunMore: "Want to play more?",
    landingCreateFreeAccount: "Create your free account.",
    landingTrialDesc: "30 days free · unlimited plays · EN / SK / CS · save your history.",
    landingCreateAccountBtn: "Create free account →",
  ...
  sk: {
    ...
    heroSubtitle: "Zahraj si to, čo sa na Zemi bojíš opýtať.",
    ...
    tapToContinue: "Pokračuj ťuknutím",
    bodyRitual: "Postav sa. Polož ruku na hruď. Potom klepni.",
    holdSilence: "Vydrž ticho.",
    sayItAloud: "Povedz to nahlas.",
    replay: "Prehrať znova",
    author: "Ty",
    nextQuestion: "Čo ďalej?",
    askThis: "Odohrať →",
    whatsNext: "Ďalšia otázka",
    // Client name
    ...
    authEmail: "Email",
    authPassword: "Heslo",
    authPasswordMin: "Heslo (min 6 znakov)",
    authLoggingIn: "Prihlasujem...",
    authLogin: "Prihlásiť sa",
    authLogout: "Odhlásiť sa",
    authWelcomeBack: "Vitaj späť",
    authNoAccount: "Nemáš účet?",
    authCreateOne: "Vytvor si ho",
    authSignedUpAs: "Registrovaný ako",
    authLoggedInAs: "Prihlásený ako",
    authSubscribe: "Predplatiť",
    authUnlock: "Odomknúť",
    authSupernovaPlaceholder: "Zadaj Master Player kód",
    authSupernovaHave: "Máš Master Player kód?",
    authOr: "alebo",
    authCheckoutError: "Niečo sa pokazilo. Skús znova.",
    authWrongCredentials: "Nesprávny email alebo heslo.",
    // Password reset
    authForgotPassword: "Zabudnuté heslo?",
    authResetTitle: "Obnoviť heslo",
    authResetDesc: "Pošleme ti odkaz na obnovenie.",
    authResetSend: "Odoslať odkaz",
    authResetSending: "Odosielam...",
    authResetSent: "Skontroluj email, poslali sme ti odkaz.",
    authNewPassword: "Nové heslo",
    authNewPasswordMin: "Nové heslo (min 6 znakov)",
    authResetSave: "Uložiť nové heslo",
    authResetSaving: "Ukladám...",
    authResetSuccess: "Heslo zmenené. Presmerovávam...",
    // History
    historyAll: "Všetky",
    historyNoFavorites: "Zatiaľ žiadne obľúbené",
    historyPlays: "hier",
    historyPlay: "hra",
    // Landing page
    landingHeroLabel: "Play Simulator",
    ...
    landingNamePlaceholder: "Tvoje meno",
    landingCTA: "Vezmi to na Mars →",
    landingCTALoading: "Vytváram...",
    landingTrust: "1 hra zdarma · bez registrácie · potom 30 dní zdarma s účtom",
    landingTrustExpired: "Využil si svoju voľnú hru · vytvor si účet a pokračuj",
    landingHaveAccount: "Už máš účet?",
    landingSignIn: "Prihlásiť sa",
    landingAskElse: "Opýtať sa inak",
    landingYourPlay: "Tvoja hra",
    landingCreatingPlay: "Vytváram tvoju hru...",
    landingChoreographing: "Choreografujem javisko...",
    landingPerspectivesRevealed: "Odhalené perspektívy",
    landingJustRanTitle: "Práve si sa hral so svojou realitou",
    landingRunMore: "Chceš hrať ďalej?",
    landingCreateFreeAccount: "Vytvor si účet zdarma.",
    landingTrialDesc: "30 dní zdarma · neobmedzené hry · EN / SK / CS · ukladaj si históriu.",
    landingCreateAccountBtn: "Vytvoriť účet zdarma →",
  ...
  cs: {
    ...
    heroSubtitle: "Zahraj si to, na co se na Zemi bojíš zeptat.",
    ...
    tapToContinue: "Pokračuj klepnutím",
    bodyRitual: "Postav se. Polož ruku na hrudník. Pak klepni.",
    holdSilence: "Vydrž ticho.",
    sayItAloud: "Řekni to nahlas.",
    replay: "Přehrát znovu",
    author: "Ty",
    nextQuestion: "Co dál?",
    askThis: "Odehrát →",
    whatsNext: "Další otázka",
    // Client name
    ...
    authEmail: "Email",
    authPassword: "Heslo",
    authPasswordMin: "Heslo (min 6 znaků)",
    authLoggingIn: "Přihlašuji...",
    authLogin: "Přihlásit se",
    authLogout: "Odhlásit se",
    authWelcomeBack: "Vítej zpět",
    authNoAccount: "Nemáš účet?",
    authCreateOne: "Vytvoř si ho",
    authSignedUpAs: "Registrovaný jako",
    authLoggedInAs: "Přihlášen jako",
    authSubscribe: "Předplatit",
    authUnlock: "Odemknout",
    authSupernovaPlaceholder: "Zadej Master Player kód",
    authSupernovaHave: "Máš Master Player kód?",
    authOr: "nebo",
    authCheckoutError: "Něco se pokazilo. Zkus znovu.",
    authWrongCredentials: "Špatný email nebo heslo.",
    // Password reset
    authForgotPassword: "Zapomenuté heslo?",
    authResetTitle: "Obnovit heslo",
    authResetDesc: "Pošleme ti odkaz na obnovení.",
    authResetSend: "Odeslat odkaz",
    authResetSending: "Odesílám...",
    authResetSent: "Zkontroluj email, poslali jsme ti odkaz.",
    authNewPassword: "Nové heslo",
    authNewPasswordMin: "Nové heslo (min 6 znaků)",
    authResetSave: "Uložit nové heslo",
    authResetSaving: "Ukládám...",
    authResetSuccess: "Heslo změněno. Přesměrovávám...",
    // History
    historyAll: "Všechny",
    historyNoFavorites: "Zatím žádné oblíbené",
    historyPlays: "her",
    historyPlay: "hra",
    // Landing page
    landingHeroLabel: "Play Simulator",
    ...
    landingNamePlaceholder: "Tvoje jméno",
    landingCTA: "Vezmi to na Mars →",
    landingCTALoading: "Vytvářím...",
    landingTrust: "1 hra zdarma · bez registrace · pak 30 dní zdarma s účtem",
    landingTrustExpired: "Využil jsi svoji volnou hru · vytvoř si účet a pokračuj",
    landingHaveAccount: "Už máš účet?",
    landingSignIn: "Přihlásit se",
    landingAskElse: "Zeptat se jinak",
    landingYourPlay: "Tvoje hra",
    landingCreatingPlay: "Vytvářím tvoji hru...",
    landingChoreographing: "Choreografuji jeviště...",
    landingPerspectivesRevealed: "Odhalené perspektivy",
    landingJustRanTitle: "Právě sis hrál se svou realitou",
    landingRunMore: "Chceš hrát dál?",
    landingCreateFreeAccount: "Vytvoř si účet zdarma.",
    landingTrialDesc: "30 dní zdarma · neomezené hry · EN / SK / CS · ukládej historii.",
    landingCreateAccountBtn: "Vytvořit účet zdarma →",
