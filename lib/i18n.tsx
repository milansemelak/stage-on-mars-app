...
const translations = {
  ...
  sk: {
    ...
    heroSubmit: "Poď na Mars",
    credibility: "Stage on Mars a Metódu Systemickej hry využívajú popredné firmy naprieč Európou, predstavili sme ju na konferenciách Forbes a priniesli do prime-time reality. Zažite ju naživo v našom flagship priestore v Prahe.",
  ...
  cs: {
    ...
    heroSubmit: "Pojď na Mars",
    credibility: "Stage on Mars a Metodu Systemické hry využívají přední firmy napříč Evropou, představili jsme ji na konferencích Forbes a přinesli do prime-time reality. Zažijte ji naživo v našem flagship prostoru v Praze.",
