...
const translations = {
  en: {
    ...
    stepAsk: "Ask",
    stepAskDesc: "What's alive in you right now?",
    stepPlay: "Play",
    stepPlayDesc: "Your question becomes a stage.",
    stepSee: "See",
    stepSeeDesc: "What you couldn't see alone.",
    // Loading messages
  ...
  sk: {
    ...
    stepAsk: "Opýtaj sa",
    stepAskDesc: "Čo v tebe práve žije?",
    stepPlay: "Hraj",
    stepPlayDesc: "Tvoja otázka sa stane javiskom.",
    stepSee: "Pozri",
    stepSeeDesc: "Čo si sám nevidel.",
    // Character generator
  ...
  cs: {
    ...
    stepAsk: "Zeptej se",
    stepAskDesc: "Co v tobě právě žije?",
    stepPlay: "Hraj",
    stepPlayDesc: "Tvoje otázka se stane jevištěm.",
    stepSee: "Podívej",
    stepSeeDesc: "Co jsi sám neviděl.",
    // Character generator
    characterGeneratorTitle: "Generátor rolí",
